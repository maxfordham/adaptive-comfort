...
class Tm52CalcWizard:
    ...
    def run_criteria(self, inputs):
        ...
        Args:
            inputs (Tm52InputData): Class instance containing the required inputs.
        """
        arr_criterion_one_bool, arr_criterion_one_percent = self.run_criterion_one(
            inputs.arr_occupancy
        )
        arr_criterion_two_bool, arr_criterion_two_max = self.run_criterion_two(
            inputs.arr_occupancy
        )
        ...
        self.di_criteria = {
            "Criterion 1": {
                ...
                "Criterion 1 (% Hours Delta T >= 1K)": arr_criterion_one_percent.round(
                    2
                ),
            },
            "Criterion 2": {
