    ...
    def run_criteria(self, inputs):
        ...
        self.di_criteria = {
            "Fixed Temp Criterion": {
                ...
                "Fixed Temp Criterion (% Hours Operative Temp > 26 Deg. Celsius)": self.arr_criterion_one_percent.round(
                    2
                ),
            },
        }
...
if __name__ == "__main__":
    ...
    calc = Tm59MechVentCalcWizard.from_files(DIR_TESTJOB1_TM59MECHVENT)
